...
export default function PortfolioPage() {
  return (
    <div>
        ...
        <div className="relative flex h-full items-center justify-center">
          ...
          <div className="mx-auto flex w-full max-w-screen-xl flex-col items-center space-y-8 px-8 xs:space-y-16 lg:items-start">
            <div className="flex flex-col items-center justify-center space-y-4 lg:items-start">
              <Link
                href="/"
                className="group absolute left-4 top-4 flex items-center gap-1.5 rounded-full bg-neutral-fade py-1 pl-2 pr-3 font-medium text-neutral-fade hover:text-neutral"
              >
              ...
              functional prototypes, <br /> tangible results. */}
                <span className="tracking-tight text-neutral xs:whitespace-normal">
      ...
      <main className="flex w-full translate-y-[1080px] flex-col items-center bg-fade pt-0 sm:pt-16 lg:translate-y-[614px] lg:pt-24">
        ...
        <section className="flex w-full flex-col items-center gap-16 pt-24 lg:pt-0">
          {/*   <p className="w-full text-center uppercase tracking-widest text-neutral">
        ...
        <section className="flex w-full flex-col items-center gap-16 pt-80">
          <div className="relative mx-auto grid w-full max-w-7xl grid-cols-1 gap-12 px-8 sm:grid-cols-2 lg:grid-cols-4">
            <svg
              ...
              fill="none"
              aria-hidden="true"
              className="stroke-fg-neutral-fade/20 absolute inset-x-0 -top-60 -z-10 h-32 w-full "
            >
              <path
        ...
        <section className="w-full overflow-hidden pb-16 pt-32 text-5xl tracking-tighter sm:text-6xl md:pt-48 lg:text-8xl">
          <div className="relative flex -rotate-3 space-x-2 md:space-x-1.5">
            <h2 className="animate-[translateX-0--100_24s_linear_infinite] flex-nowrap space-x-2 whitespace-nowrap font-medium uppercase text-neutral-fade/25 md:space-x-3">
              <span>Featured projects ✲</span>
              <span>Featured projects ✲</span>
            </h2>
            <h2 className="absolute animate-[translateX-100-0_24s_linear_infinite] flex-nowrap space-x-6 whitespace-nowrap font-medium uppercase text-neutral-fade/25">
              <span>Featured projects ✲</span>
              <span>Featured projects ✲</span>
            </h2>
          </div>
        ...
        <section className="mx-auto w-full max-w-[1376px] pb-24 pt-16 md:px-8 md:pt-48">
          <h2 className="p-8 text-5xl font-extrabold text-neutral md:ml-12 md:px-0 md:text-left">
        ...
        <section className="mx-auto w-full max-w-screen-xl px-8 pb-24 pt-8 md:pb-48 md:pt-48">
          <h2 className="text-5xl font-extrabold text-neutral md:text-left">
            How I work
          </h2>
          {/*     <p className="pt-4 text-center text-xl text-neutral-fade">
          ...
          <div className="grid grid-cols-1 gap-16 pt-16 md:grid-cols-2 md:pt-20">
            ...
            <div className="space-y-4">
              ...
              <div className="relative aspect-video">
                <Image
                  src={'/images/no-code.jpg'}
                  fill
                  alt="Make no-code automation"
                />
              </div>
            </div>
          </div>
        ...
        {/*         <section className="mx-auto w-full max-w-screen-xl space-y-20 px-8 pb-24 md:pb-96 md:pt-24">
          <h2 className="text-5xl font-extrabold text-neutral md:text-left">FAQ</h2>
          <ul>
            <li>
