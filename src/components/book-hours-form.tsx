    ...
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
      <div className="flex flex-col justify-between gap-10 rounded-[32px] bg-neutral p-12">
        ...
        <p className="h-full text-xl">
          Flexible design partner services for one-time or ongoing projects
          ...
          >
            ...
            <div className="flex w-full flex-col gap-4 md:flex-row">
              <input
                ...
                className="focus-visible:ring-border-primary w-full rounded-xl border-neutral pl-6 text-xl focus-visible:border-primary"
              />
              <button
                type="submit"
                disabled={hours >= 1 && hours < 1000 ? false : true}
                className="right-0 flex w-full items-center justify-center space-x-4 place-self-start self-end whitespace-nowrap rounded-full bg-primary px-8 py-4 text-center text-xl font-bold tracking-wide text-white transition-transform hover:rotate-2 hover:scale-105 disabled:bg-black/20 hover:disabled:rotate-0 hover:disabled:scale-100"
              >
                <span>
                  Book{' '}
                  {hours >= 1 && hours < 1000
