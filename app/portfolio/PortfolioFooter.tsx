  ...
  return (
    <footer className="w-full bg-page px-8 py-24 pb-8">
      <div className="mx-auto flex max-w-screen-xl flex-col items-center space-y-16">
        <h2 className="text-center text-5xl font-extrabold">Book a Free Consultation</h2>
        <p className="max-w-screen-sm text-center text-2xl text-fg-neutral">
          <Balancer>
            Schedule a no-obligation call to explore how I can help you grow your business
            through design.
          </Balancer>
        </p>
        ...
        <p className="flex w-full flex-col justify-between gap-2 pt-32 text-center text-lg text-fg-neutral md:flex-row">
          <span>MB Service Intent (Reg. number: 305604744) ✲ Lithuania / Denmark</span>
          <span>
            Design ♡ Code by{' '}
