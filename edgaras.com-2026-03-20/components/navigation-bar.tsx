...
import { MoonIcon } from '@/components/icons/outline'
import { ChevronUpDownIcon } from '@/components/icons/outline'
...
export const NavigationBar = () => {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 flex justify-center p-2 xs:p-4 standalone:pb-safe-area-inset-bottom">
